...
namespace Rad301_Mock_Exam_2023_DataModel_S00227213
{
    public class FlightContext : DbContext
    {
            ...
            : base(options)
        {
            ActivityAPIClient.Track(StudentID: "S00227213", StudentName: "Jack Monaghan",
                                    activityName: "Rad301 Mock Exam 2023", Task: "Seeding Data Model");
        }
    ...
    public class FlightContextFactory : IDesignTimeDbContextFactory<FlightContext>
    {
        public FlightContext CreateDbContext(string[] args)
        {
            ...
            builder.UseSqlServer("Data Source=(localdb)\\ProjectModels;Initial Catalog=FlightExamDb;Integrated Security=True;");
